...
function World () {
    ...
    let shapeType = ["gumdrop", "ornament", "peppermint", "treelimb", "candycane", "sphere", "house", "candystrip", "gummybear", "wreath", "icingSphere"];
    ...
    this.draw = (m, drawShape) => {
        let drawObject = (o) => {
            ...
            else if (o.shape == "icingSphere") shapeVertices = CG.icingSphere;
